...
public class HoldingBlockBeta : MonoBehaviour {
...
//        }
		...
		if(_blocs.v_numberOfLinks > 2){
			...
			gameObject.GetComponent<Renderer>().material.Lerp(gameObject.GetComponent<Renderer>().material, _firstMat, (resetSpeed*Time.deltaTime)/colorSpeed);
		}
