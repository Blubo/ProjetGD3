...
//					pointA.rigidbody2D.isKinematic = true;
					distJoint.connectedBody = chain.rigidbody;
					pointA.rigidbody.isKinematic = true;
				}
//				else chain.rigidbody2D.isKinematic = lockFirstChain;
				else chain.rigidbody.isKinematic = lockFirstChain;
			}
...
//				tempChainHinge.connectedBody = chain.rigidbody2D;
				tempChainHinge.connectedBody = chain.rigidbody;
...
//					chainHinge.connectedBody = tempChain.rigidbody2D;
					...
					chainHinge.connectedBody = tempChain.rigidbody;
					//set anchor position
					if(!connectToA)
					{
...
//					chain.rigidbody2D.isKinematic = true;
					chain.rigidbody.isKinematic = true;
